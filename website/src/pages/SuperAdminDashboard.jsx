                          ...
                          {d.stream_url ? (
                            <a 
                              ...
                              onClick={(e) => {
                                ...
                                window.open(adminUrl, `Stream_${d.serial || 'Device'}`, `width=${w},height=${h},top=${top},left=${left},resizable=yes,scrollbars=no,status=no,location=no,toolbar=no,menubar=no,popup=yes`);
                              }}
                            >
